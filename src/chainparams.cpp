...
public:
    CMainParams() {
        ...
        consensus.SetBIP34Params(227931, "0x000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8");
        consensus.SetBIP65Params(388381); // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.SetBIP66Params(363725); // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 210000;
        consensus.SetBIP34Params(21111, "0x0000000023b3a96d3484e5abb3755c413e7d41500f8e2a5c3f0dd01299cd8ef8");
        consensus.SetBIP65Params(581885); // 00000000007f6655f22f98e72ed80d8b06dc761d5da09df0fa1dc4be4f861eb6
        consensus.SetBIP66Params(330776); // 000000002104c8c45e99a8853285a3b592602a3ccde2b832481da85e9e4ba182
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
...
public:
    CRegTestParams() {
        ...
        consensus.SetBIP34Params(100000000); // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests)
        consensus.SetBIP65Params(1351); // BIP65 activated on regtest (Used in rpc activation tests)
        consensus.SetBIP66Params(1251); // BIP66 activated on regtest (Used in rpc activation tests)
