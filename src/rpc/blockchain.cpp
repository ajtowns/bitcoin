...
static UniValue SoftForkMajorityDesc(int version, const CBlockIndex* pindex, const Consensus::Params& consensusParams)
{
    ...
    switch(version)
    {
        case 2:
            ...
            break;
        case 3:
            activated = VersionBitsActive(pindex->pprev, consensusParams, Consensus::DEPLOYMENT_STRICTDER, vbcache);
            break;
        case 4:
            activated = VersionBitsActive(pindex->pprev, consensusParams, Consensus::DEPLOYMENT_CLTV, vbcache);
            break;
    }
...
static UniValue BIP9SoftForkDesc(const Consensus::Params& consensusParams, Consensus::DeploymentPos id)
{
    ...
    rv.pushKV("flagtime", consensusParams.vDeployments[id].nFlagTime);
