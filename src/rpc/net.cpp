        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::STR, "template_status",
                     "Template sharing status: \"active\" (requesting/accepting templates), "
                     "\"inactive\" (supports but not currently selected), "
                     "\"unsupported\" (does not support BIN25-2)."},
                }},
            }},
        },
        RPCExamples{
...
static RPCMethod gettemplateinfo()
{
    return RPCMethod{"gettemplateinfo",
        "EXPERIMENTAL warning: this call may be changed in future releases.\n"
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            node::TemplateInfo info{peerman.GetTemplateInfo()};
