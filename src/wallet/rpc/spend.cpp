...
{
    RPCArg psbt{"psbt", RPCArg::Type::STR, RPCArg::Optional::NO, "The transaction base64 string"};
    RPCArg sign{"sign", RPCArg::Type::BOOL, RPCArg::Default{true}, "Also sign the transaction when updating (requires wallet to be unlocked)"};
    RPCArg sighashtype{"sighashtype", RPCArg::Type::STR, RPCArg::Default{"DEFAULT for Taproot, ALL otherwise"}, "The signature hash type to sign with if not specified by the PSBT. Must be one of\n"
                    "       \"DEFAULT\"\n"
                    "       \"ALL\"\n"
                    "       \"NONE\"\n"
                    "       \"SINGLE\"\n"
                    ...
                    "       \"NONE|ANYONECANPAY\"\n"
                    "       \"SINGLE|ANYONECANPAY\""};
    RPCArg bip32derivs{"bip32derivs", RPCArg::Type::BOOL, RPCArg::Default{true}, "Include BIP 32 derivation paths for public keys if we know them"};
    RPCArg finalize{"finalize", RPCArg::Type::BOOL, RPCArg::Default{true}, "Also finalize inputs if possible"};
    RPCArg options{"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
             { sign, sighashtype, bip32derivs, finalize },
                    RPCArgOptions{.oneline_description="options"}};
    ...
    return RPCHelpMan{"walletprocesspsbt",
        ...
        HELP_REQUIRING_PASSPHRASE,
                (RPCHelpMan::EnabledDeprecatedRPC(RPCHelpMan::WALLETPROCESSPSBT) ? std::vector<RPCArg>{psbt, sign, sighashtype, bip32derivs, finalize} : std::vector<RPCArg>{psbt, options}),
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
