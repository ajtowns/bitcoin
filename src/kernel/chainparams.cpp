...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_OPCAT] = SetupDeployment{.year = 2024, .number = 1, .revision = 0, .never = true};
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_OPCAT] = SetupDeployment{.year = 2024, .number = 1, .revision = 0, .always = true};
