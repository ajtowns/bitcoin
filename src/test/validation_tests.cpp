...
BOOST_AUTO_TEST_CASE(signet_parse_tests)
{
    ...
    const auto signet_params = CreateChainParams(signet_argsman, kernel::chainname::SIGNET);
    CBlock block;
...
{
    const auto params = CreateChainParams(*m_node.args, kernel::chainname::REGTEST);
