...
BOOST_AUTO_TEST_CASE(test_IsStandard)
{
    ...
    // ...and so long as individual pushes are smallish
    t.vout[0].scriptPubKey = CScript() << OP_RETURN << ""_hex;
    BOOST_CHECK_EQUAL(1+3+521, t.vout[0].scriptPubKey.size());
    CheckIsNotStandard(t, "datacarrier-largepush");
    t.vout[0].scriptPubKey = CScript() << OP_RETURN << ""_hex << "00"_hex;
    BOOST_CHECK_EQUAL(1+3+520+1+1, t.vout[0].scriptPubKey.size());
    CheckIsStandard(t);
