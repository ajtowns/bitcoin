...
CTxMemPoolEntry ConsumeTxMemPoolEntry(FuzzedDataProvider& fuzzed_data_provider, const CTransactionRef& ptx, uint32_t max_height) noexcept
{
    // Avoid:
    ...
    return CTxMemPoolEntry{ptx, fee, time, entry_height, entry_sequence, spends_coinbase, sig_op_cost, {}};
}
