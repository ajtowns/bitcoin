            ...
            ForEachNoDup(conf_actions, SET, SECTION_NEGATE, [&] {
                for (bool soft_set : {false, true}) {
                    for (bool force_set : {false, true}) {
                        for (const std::string& section : {kernel::chainname::MAIN, kernel::chainname::TESTNET, kernel::chainname::SIGNET}) {
                            for (const std::string& network : {kernel::chainname::MAIN, kernel::chainname::TESTNET, kernel::chainname::SIGNET}) {
