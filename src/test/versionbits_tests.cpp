...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    for (const auto& chain_name : {kernel::chainname::MAIN, kernel::chainname::TESTNET, kernel::chainname::SIGNET, kernel::chainname::REGTEST}) {
...

    {
        ...
        const auto chainParams = CreateChainParams(args, kernel::chainname::REGTEST);
