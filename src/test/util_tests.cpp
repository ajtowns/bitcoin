...
BOOST_FIXTURE_TEST_CASE(util_CheckValue, CheckValueTest)
{
    ...
    CheckValues(nullptr,
                ...
                M::ALLOW_INT,                    Expect{{}}.DefaultInt(),
                M::ALLOW_STRING,                 Expect{{}}.DefaultString(),
    ...
    CheckValues("-value=0",
                ...
                M::ALLOW_INT,                    Expect{"0"}.Int(0),
                M::ALLOW_STRING,                 Expect{"0"}.String("0"),
    ...
    CheckValues("-value=1",
                ...
                M::ALLOW_INT,                    Expect{"1"}.Int(1),
                M::ALLOW_STRING,                 Expect{"1"}.String("1"),
