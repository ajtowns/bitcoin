...
BOOST_AUTO_TEST_CASE(package_hash_tests)
{
    ...
    CTransactionRef ptx_1{MakeTransactionRef(deserialize, TX_WITH_WITNESS, stream_1)};
    const CTransaction& tx_1 = *ptx_1;
    ...
    CTransactionRef ptx_2{MakeTransactionRef(deserialize, TX_WITH_WITNESS, stream_2)};
    const CTransaction& tx_2 = *ptx_2;
    ...
    CTransactionRef ptx_3{MakeTransactionRef(deserialize, TX_WITH_WITNESS, stream_3)};
    const CTransaction& tx_3 = *ptx_3;
