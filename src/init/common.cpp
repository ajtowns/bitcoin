...
void AddLoggingArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-logjson", strprintf("Write log lines as JSON objects instead of human-readable text (default: %u)", DEFAULT_LOGJSON), ArgsManager::ALLOW_ANY, OptionsCategory::DEBUG_TEST);
...
void SetLoggingOptions(const ArgsManager& args)
{
    ...
    LogInstance().m_log_json = args.GetBoolArg("-logjson", DEFAULT_LOGJSON);
