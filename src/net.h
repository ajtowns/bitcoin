...
using mapMsgTypeSize = std::map</* message type */ std::string, /* total bytes */ uint64_t, std::less<>>;
...
public:
    ...
    std::atomic<uint8_t> m_bip324_crazy_mode{0}; // 0=no, 1=available, 2=active; should be in Peer :(
