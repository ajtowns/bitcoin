...
/** Total possible bits available for versionbits */
static const int32_t VERSIONBITS_NUM_BITS = 29;
/** Total available bits after BIPxxx extended nVersion nonce */
static constexpr int VERSIONBITS_BIPXXX_NUM_BITS{5};
