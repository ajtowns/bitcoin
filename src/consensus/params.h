 ...
 */
struct SignalledDeploymentParams {
...
struct Params {
    ...
    int MinSignalledDeploymentWarningHeight;
    /**
    ...
    SignalledDeploymentParams vDeployments[MAX_VERSION_BITS_DEPLOYMENTS];
