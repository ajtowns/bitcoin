...
bool CNodeState::TxDownloadState::GetTx(uint256& txid, std::chrono::microseconds current_time)
{
...
void CNodeState::TxDownloadState::MarkInFlight(const uint256& txid, std::chrono::microseconds current_time)
{
