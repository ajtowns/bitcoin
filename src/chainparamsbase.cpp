...
void SetupChainParamsBaseOptions()
{
    ...
    gArgs.AddArg("-guaranteedact=deployment", "Ensure mandatory activation of named deployment", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
}
