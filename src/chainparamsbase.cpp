...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-signetacceptreorg", strprintf("Accept blocks flagged to be eventually reorged out (signet-only; default: %d)", DEFAULT_SIGNET_ACCEPT_REORG), ArgsManager::ALLOW_BOOL, OptionsCategory::CHAINPARAMS);
}
