...
If --txid=raw or --txid=rawhash is specified, txid will be BLOB instead; if --spk=raw,
then scriptpubkey will be BLOB instead.
"""
import argparse
import os
import sqlite3
...
def main():
    ...
    parser.add_argument('--txid', choices=['hex', 'raw', 'rawhash'], default='hex', help='encode txid as hex, raw bytes, or raw bytes in sha256 byteorder')
    ...
    txid_reverse = (args.txid != 'rawhash')
