...
def main():
    ...
    generate.add_argument("N", default=1, type=int, help="How many blocks to generate (0 or -1 for no limit)")
    generate.add_argument("--block-time", default=600, type=int, help="How long between blocks")
    generate.add_argument("--target-mining-time", default=None, type=int, help="How long to spend mining before finding a block")
