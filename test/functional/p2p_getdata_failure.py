...
class InvalidTxRequestTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        time.sleep(2*60) # mocktime doesn't work :(
        self.p2p_withheld_tx(20)
        assert_equal(len(node.p2p.getdata_requests), 0) # not enough time to start requesting from this node
        self.log.info("Now have 40 unasked-for transactions queued...")
