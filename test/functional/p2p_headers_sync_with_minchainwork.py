...
class RejectLowDifficultyHeadersTest(BitcoinTestFramework):
    ...
    def test_peerinfo_includes_headers_sync_height(self):
        self.log.info("Test that getpeerinfo() includes headers sync height")
        ...
        assert_equal(node.getpeerinfo()[0]['headers_height_current_sync'], 2000)

    def run_test(self):
        self.test_chains_sync_when_long_enough()

        self.test_peerinfo_includes_headers_sync_height()
